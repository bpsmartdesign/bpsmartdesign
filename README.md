...
<p>Welcome 😊! </br> I'm Paul, Software Engineer from  <img src="https://img.icons8.com/fluency/48/000000/cameroon-circular.png" width="15" style="transform: translateY(6px)"/> <b><em>Douala, Cameroon</em></b>.</p>
...
const bpsmartdesign = {
  ...
  technologies: {
        frontEnd: {
          ...
          misc: ["Tailwind", "Ant design", "Vuetify", "i18n", ...]
        },
        backEnd: {
          js: ["Node", "Express"],
          php: ["laravel"]
